package botUtilities.commandsSystem.manager;

import botUtilities.commandsSystem.builder.CallResponseBuilder;
import botUtilities.commandsSystem.builder.FunctionBuilder;
import botUtilities.commandsSystem.builder.ResponseBuilder;
...
public class CommandUtils {
     ...
     * @param directory the folder where all the {@link botUtilities.commandsSystem.types.Command} Json is located
    ...
    /**
     * Creates a default {@link botUtilities.commandsSystem.types.callResponse.CallResponse} command via the {@link
     * botUtilities.commandsSystem.builder.CallResponseBuilder} class and writes it to the given json file. If the file
    ...
    /**
     * Creates a minimal {@link botUtilities.commandsSystem.types.callResponse.CallResponse} command via the {@link
     * botUtilities.commandsSystem.builder.CallResponseBuilder} class and writes it to the given json file. If the file
     * does not have the .json extension, an error will be thrown.
     * <p>
    ...
    /**
     * Creates a detailed {@link botUtilities.commandsSystem.types.callResponse.CallResponse} command via the {@link
     * botUtilities.commandsSystem.builder.CallResponseBuilder} class and writes it to the given json file. If the file
     * does not have the .json extension, an error will be thrown.
     * <p>
    ...
    /**
     * Creates a default {@link botUtilities.commandsSystem.types.function.Function} via the {@link
     * botUtilities.commandsSystem.builder.FunctionBuilder} class and writes it to the given json file. If the file does
