...
import com.github.kwilinsi.commandsSystem.builder.CallResponseBuilder;
import com.github.kwilinsi.commandsSystem.builder.FunctionBuilder;
import com.github.kwilinsi.commandsSystem.builder.ResponseBuilder;
...
import com.github.kwilinsi.tools.EmbedField;
...
public class CommandUtils {
     ...
     * @param directory the folder where all the {@link Command} Json is located
    ...
    /**
     * Creates a default {@link com.github.kwilinsi.commandsSystem.types.callResponse.CallResponse} command via the {@link
     * com.github.kwilinsi.commandsSystem.builder.CallResponseBuilder} class and writes it to the given json file. If the file
    ...
    /**
     * Creates a minimal {@link com.github.kwilinsi.commandsSystem.types.callResponse.CallResponse} command via the {@link
     * com.github.kwilinsi.commandsSystem.builder.CallResponseBuilder} class and writes it to the given json file. If the file
     * does not have the .json extension, an error will be thrown.
     * <p>
    ...
    /**
     * Creates a detailed {@link com.github.kwilinsi.commandsSystem.types.callResponse.CallResponse} command via the {@link
     * com.github.kwilinsi.commandsSystem.builder.CallResponseBuilder} class and writes it to the given json file. If the file
     * does not have the .json extension, an error will be thrown.
     * <p>
    ...
    /**
     * Creates a default {@link com.github.kwilinsi.commandsSystem.types.function.Function} via the {@link
     * com.github.kwilinsi.commandsSystem.builder.FunctionBuilder} class and writes it to the given json file. If the file does
